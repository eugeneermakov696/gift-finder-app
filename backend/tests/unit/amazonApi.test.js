describe('src/services/amazonApi.js - Unit Tests', () => {
  ...
  beforeEach(() => {
    // Clears module cache to re-evaluate environment flags cleanly per test block
    jest.resetModules(); 
  ...
  describe('Offline Simulator Logic', () => {
    it('should intercept execution and return seed mock data for a known ASIN', async () => {
      ...
      expect(global.fetch).not.toHaveBeenCalled(); // Confirms zero actual network traffic was made
    });
