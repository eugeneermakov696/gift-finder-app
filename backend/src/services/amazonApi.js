...
function signRequest(payload, datetime, date) {
    ...
    // Fixed: Wrapped with backticks to support multi-line template literals
    ...
    if (isOffline) {
        ...
        if (!mockProduct) {
            return {
                ...
                price: 19.99,
                currency: 'USD',
                imageUrl: 'https://m.media-amazon.com/images/I/01placeholder.jpg',
...
module.exports = { getProductByAsin };
