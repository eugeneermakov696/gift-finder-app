...
.bgl-frame{display:grid;place-items:center;width:100%;height:100%;padding:0;overflow:hidden;background:var(--bgl-stage);font-family:var(--font-display,'Inter',ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif)}
        ...
        <div className="bgl-card" tabIndex="0">
          ...
          <div className="bgl-inner">
            ...
            <h3 className="bgl-title">
              Buy With Prime Confidence
            </h3>
            <p className="bgl-description">
              Check real price trends and verified reviews, then checkout seamlessly via your existing Amazon account.
            </p>
          </div>
        </div>
      </div>
